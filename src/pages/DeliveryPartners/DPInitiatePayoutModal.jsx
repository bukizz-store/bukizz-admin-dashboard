  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (form.receiptFile) {
        ...
        uploadData.append("folder", "dp_receipts");
      ...
      // Step 2: Execute DP Payout with the receipt URL
      await api.post(`/admin/delivery-partners/${dpId}/payout`, {
...
export default DPInitiatePayoutModal;
